...
public class StatisticDayView extends StatisticPageView {
	...
	public void load() {
		...
		if (brac_time == 0){
			...
			String month_str = context.getString(R.string.january);
			switch(month){
				case 1:
					month_str = context.getString(R.string.january);
					break;
				case 2:
					month_str = context.getString(R.string.february);
					break;
				case 3:
					month_str = context.getString(R.string.march);
					break;
				case 4:
					month_str = context.getString(R.string.april);
					break;
				case 5:
					month_str = context.getString(R.string.may);
					break;
				case 6:
					month_str = context.getString(R.string.june);
					break;
				case 7:
					month_str = context.getString(R.string.july);
					break;
				case 8:
					month_str = context.getString(R.string.august);
					break;
				case 9:
					month_str = context.getString(R.string.september);
					break;
				case 10:
					month_str = context.getString(R.string.october);
					break;
				case 11:
					month_str = context.getString(R.string.november);
					break;
				case 12:
					month_str = context.getString(R.string.december);
					break;
				default:
					// Do nothing
			}
			...
			Spannable s = new SpannableString(month_str+dot+day_str+"\n"+time_str);
			int start = 0;
